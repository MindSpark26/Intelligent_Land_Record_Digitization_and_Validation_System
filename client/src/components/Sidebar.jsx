...
/**
 * Sidebar — deep navy sidebar with saffron active-state indicators.
 */
    ...
    <aside className="fixed top-0 left-0 h-screen w-64 bg-slate-900 text-white flex flex-col z-50">
      ...
      <div className="px-6 py-6 border-b border-slate-700/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold tracking-tight">Land AI</h1>
            <p className="text-[11px] text-slate-400 font-medium tracking-wide">Digital India</p>
          </div>
        </div>
      </div>
